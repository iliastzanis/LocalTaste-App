...
class SnackItems extends StatefulWidget {
  const SnackItems({Key? key}) : super(key: key);

  @override
  State<SnackItems> createState() => _SnackItemsState();
}

class _SnackItemsState extends State<SnackItems> {
  ...
  Stream<QuerySnapshot<Map<String, dynamic>>> _getProductsStream() {
    return FirebaseFirestore.instance
        .collection('products')
        .where('category', arrayContains: 'Snack')
        .snapshots();
  }
